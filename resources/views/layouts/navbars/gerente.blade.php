...
<a href="{{ route('dashboard.gerente') }}" title="Inicio" aria-label="Inicio" class="nav-icon-link {{ request()->routeIs('dashboard.gerente') ? 'nav-icon-link-active' : '' }}">
...
<a href="{{ route('clientes.index') }}" title="Clientes" aria-label="Clientes" class="nav-icon-link {{ request()->routeIs('clientes.*') ? 'nav-icon-link-active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
...
<a href="{{ route('ventas.index') }}" title="Ventas" aria-label="Ventas" class="nav-icon-link {{ request()->routeIs('ventas.index') ? 'nav-icon-link-active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
...
<a href="{{ route('ventas.create') }}" title="Pendientes" aria-label="Pendientes" class="nav-icon-link {{ request()->routeIs('ventas.create') ? 'nav-icon-link-active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6l3.75 2.25M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>

    <span class="nav-icon-label">Pendientes</span>
    <span class="nav-tooltip">Pendientes</span>
</a>
